...
<html lang="en">
  <head>
    ...
    <title>NEETHI - Product Detail</title>
    <!-- Fonts-->
...
if($_GET['ItemId'])
{
  ...
  $res=$product1->SelectProductDetailsById($id);

 
  $result=mysqli_fetch_assoc($res);
  $actualprice=((int)($result['SellingPrice']))-((int)($result['SellingPrice'])*(int)($result['Discount'])/100);
              ...
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  ...
                  <?php
                    ...
                    $result22=$product1->SelectImageDetailsByIdRowCount($id);

                  //  $result2=mysqli_fetch_assoc($Imageresult);
                    while($row=mysqli_fetch_array($Imageresult))
                      {
                    echo   '<div class="item"><img src="Admin/'.$row['ImageUrl'].'" alt=""></div>';
                   
                      }
                      if($result22<=0)
                      {
                        echo   '<div class="item"><img src="Admin/upload/default.jpg" alt=""></div>';
...
while($row=mysqli_fetch_array($Imageresult))
  {
echo '<div class="item"><img class="zoom" src="Admin/'.$row['ImageUrl'].'" alt="" data-zoom-image="Admin/'.$row['ImageUrl'].'"></div>';
  }
  if($result22<=0)
{
 echo '<div class="item"><img class="zoom" src="Admin/upload/default.jpg" alt="" data-zoom-image="Admin/upload/default.jpg"></div>';
...
?>
              ...
              <?php  
              // $Imageresult=$product1->SelectImageDetailsById($id);
             //  $result24=$product1->SelectImageDetailsByIdRowCount($id);
             //  $result23=mysqli_fetch_assoc($Imageresult);

              if($result22<=0)
               {
             
                echo '<img src="Admin/upload/default.jpg" alt="">';
               
                }
                else
                {
                  echo '<img src="Admin/'.$result2['ImageUrl'].'" alt="">';
...
?>
 ...
 while($row=mysqli_fetch_array($Imageresult))
  {
echo '<img  src="Admin/'.$row['ImageUrl'].'" alt="">';
  }
  if($result22<=0)
{
 echo '<img src="Admin/upload/default.jpg" alt="">';
...
?>
              ...
              <div class="ps-product__info">
                ...
                <h1 id="priceIdsendtocheckout" style="display:none"><?php echo $actualprice; ?></h1>
                <h1 id="nameId"><?php echo $result['ItemName'] ?></h1>
                <h3 class="ps-product__price"> <?php echo 'Rs '. $actualprice; ?></h3>
                ...
                <div class="ps-product__block ps-product__size">
                  ...
                  <select class="ps-select selectpicker" name="drpsize" id="drpsizeid">>
                    <option value="1">4</option>
                    <option value="2">5</option>
                  ...
                  <div class="form-group">
                    <input class="form-control" type="number" value="1" id="numberid">
                  </div>
                </div>
                <div class="ps-product__shopping" id="tstId"><a class="ps-btn mb-10"  href="#">Add to cart<i class="ps-icon-next"></i></a>
...
$result=$product1->SelectProductDetailsByCashRange($result['SellingPrice'],$result['ItemId']);
