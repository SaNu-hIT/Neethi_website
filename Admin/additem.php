...
{
$id=$_GET['id'];
echo "<span id='hdnId' style='display:none'>".$id."</span>";
$result=$product1->SelectProductDetailsById($id);
$res=mysqli_fetch_assoc($result);
  ...
  $imgUrl3="";
  $imgUrl4="";
  $Imageresult=$product1->SelectImageDetailsById($id);
  $i=1;
   while($row1=mysqli_fetch_array($Imageresult))
   {
       //echo"dsds".$row1["ImageUrl"];

    if($i==1)
    $imgUrl1 =$row1["ImageUrl"];

    if($i==2)
    $imgUrl2 =$row1["ImageUrl"];

    if($i==3)
    $imgUrl3= $row1["ImageUrl"];

    if($i==4)
    $imgUrl4 =$row1["ImageUrl"];
      $i=$i+1;
   }
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!--<script type="text/javascript" src="Script/image_script.js"></script> -->
...
@-moz-keyframes bounce_fountainG{
                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="gi gi-notes_2"></i>Add Product <br><small></small>
                            </h1>
                        </div>
                    </div>
                    <ul class="breadcrumb breadcrumb-top">
                        <li>Home</li>
                        <li><a href="">Add Product Details</a></li>
                    </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <form id="formId" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-text-input">Item Name</label>
                                        <div class="col-md-9">
                                            <input type="text" id="text-itemName" name="example-text-input" class="form-control" placeholder="Item Name" value= "<?php  echo $res['ItemName'] ?>" >
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-email-input">Item Code</label>
                                        <div class="col-md-9">
                                            <input type="text" id="text-itemCode" name="example-email-input" class="form-control" placeholder="Item Code" value= "<?php  echo $res['ItemCode'] ?>" >
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-password-input">Selling Price</label>
                                        <div class="col-md-3">
                                            <input type="number" id="text-sellingPrice" name="example-password-input" class="form-control" placeholder="Selling Price" value= "<?php  echo $res['SellingPrice'] ?>" >
                                            <span class="help-block"></span>
                                        </div>
										
										<label class="col-md-3 control-label" for="example-password-input">Discount Price</label>
                                        <div class="col-md-3">
                                            <input type="number" id="text-discountPrice" name="example-password-input" class="form-control" placeholder="Discount Price" value= "<?php  echo $res['Discount'] ?>" >
                                            <span class="help-block"></span>
                                        </div>
                                    </div>
                                   
								     <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-password-input">Model</label>
                                        <div class="col-md-3">
                                            <input type="text" id="text-model" name="example-password-input" class="form-control" placeholder="Model" value= "<?php  echo $res['Model'] ?>" >
                                            <span class="help-block"></span>
                                        </div>
										
										<label class="col-md-3 control-label" for="example-password-input">Product Selling Type</label>
                                        <div class="col-md-3">
                                        <select id="text-ProductsellingType" name="example-chosen" class="form-control"  style="width: 250px;">
                                        <option value="NML" <?= $res['SellingFlag'] == 'NML' ? ' selected="selected"' : '';?>>Normal Product</option>  
                                        <option value="FTR" <?= $res['SellingFlag'] == 'FTR' ? ' selected="selected"' : '';?>>Featured Product</option>
                                        <option value="TOP" <?= $res['SellingFlag'] == 'TOP' ? ' selected="selected"' : '';?>>Top Selling Product</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-textarea-input">Item Description</label>
                                        <div class="col-md-9">
                                            <textarea id="text-Description" name="example-textarea-input" rows="9" class="form-control" placeholder="Content.."><?php  echo $res['ItemDescription'] ?></textarea>
                                        </div>
                                    </div>

                                    <div class="form-group" style="display:none">
                                        <label class="col-md-3 control-label" for="example-file-multiple-input">Image 1</label>
                                        <div class="col-md-9">
                                            <input type="file"   id="text-image1" class="form-control" name="example-file-multiple-input">
                                            <span id="imageid1"></span>
                                            <img id="prev1" width="100" height="100" src="<?php echo $imgUrl1 ?>" />
                                            </div>
                                    </div>
                                   
									 <div class="form-group" style="display:none">
                                        <label class="col-md-3 control-label" for="example-file-multiple-input">Image 2</label>
                                        <div class="col-md-9">
                                            <input type="file" id="text-image2" class="form-control" name="example-file-multiple-input">
                                            <span id="imageid2"></span>
                                            <img id="prev2" width="100" height="100" src="<?php echo $imgUrl2 ?>"/>
   ...
   while($res=mysqli_fetch_array($Imageresult))

   {
      

                         echo '<img id="prev4" width="100" height="100" src="'.$res["ImageUrl"].'">';
                         echo  '<a href="javascript:void(0)" class="btn btn-sm btn-danger1" id="'.$res["ImageId"].'" data-toggle="tooltip" title="Delete"><i class="fa fa-times"></i></a>';   
                            ...
                            ?>
                                    ...
                                    <div class="form-group form-actions">
                                        <div class="col-md-9 col-md-offset-3">
                                            <button type="submit" id="btnId" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Submit</button>
                                            <button type="reset" id="btnreset" class="btn btn-sm btn-warning"><i class="fa fa-repeat"></i> Reset</button>
                                        </div>
                                    </div>
                                </form>
