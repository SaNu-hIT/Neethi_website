            ...
            <div id="loading_container3">
                <div id="loading_container4">
                    Loading, please wait...
 						 ...
 						 <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-file-multiple-input">Image 3</label>
                                        <div class="col-md-9">
                                            <input type="file" id="text-image3" class="form-control" name="example-file-multiple-input">
                                            <span id="imageid3"></span>
                                            <img id="prev3" width="100"  height="100" src="<?php echo $imgUrl3 ?>"/>
                                         
                                        </div>
                                    </div>
									 <div class="form-group">
                                        <label class="col-md-3 control-label" for="example-file-multiple-input">Image 4</label>
                                        <div class="col-md-9">
                                            <input type="file" id="text-image4" class="form-control" name="example-file-multiple-input">
                                            <span id="imageid4"></span>
                                            <img id="prev4" width="100" height="100" src="<?php echo $imgUrl4 ?>"/>
