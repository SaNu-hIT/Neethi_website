    ...
    <body>
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><i class="gi gi-flash"></i> <strong>NEETHI</strong><br><small>Please <strong>Login</strong> or <strong>Register</strong></small></h1>
            </div>
            <!-- END Login Title -->
                ...
                <div  class="form-horizontal form-bordered form-control-borderless">
                    ...
                    <div class="form-group form-actions">
                        ...
                        <div class="col-xs-8 text-right">
                            <button type="submit"  id="btnlogin" class="btn btn-sm btn-primary"> <a href="dashboard.html"><i class="fa fa-angle-right"></i></a> Login to Dashboard</button>
                        </div>
                    </div>
                    <div class="form-group">
